...
for i=1:num_epoch
    for j=1:num_batch
        ...
        [hidden_output, batch_preds, batch_loss] = forward_prop_relu(X_batch, y_batch, W1, b1, W2, b2, lambda);
        [dW1, db1, dW2, db2] = backward_prop_relu(X_batch, batch_preds, y_batch, batch_size, hidden_output...
            ,W1, b1, W2, b2, lambda);
    ...
    [~, dev_preds, dev_set_loss] = forward_prop_relu(X_dev, y_dev, W1, b1, W2, b2, lambda);
...
[~, test_pred, ~] = forward_prop_relu(X_test, y_test, W1, b1, W2, b2, lambda);
